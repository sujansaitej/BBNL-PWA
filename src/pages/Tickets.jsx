        ...
        <div className="px-4 py-1 bg-white border-b border-gray-100 space-y-2">
          <div className="relative">
            <input
              ...
              className="w-full border rounded-lg py-2 pl-10 pr-3 text-sm bg-white focus:ring-1 focus:ring-blue-500 focus:outline-none"
            />
            <Search className="absolute left-3 top-2.5 text-gray-400 w-4 h-4" />
          </div>
          { deptsAllowedTabs.includes(activeTab) && 
          <select className="w-full border rounded-lg py-2 px-3 text-sm bg-white focus:ring-1 focus:ring-blue-500 focus:outline-none" onChange={(e) => setSelectedDept(e.target.value)} value={selectedDept}>
