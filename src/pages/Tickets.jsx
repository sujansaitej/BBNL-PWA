    ...
    <div className="min-h-screen bg-gray-50 flex flex-col relative">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-40 bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-4 flex items-center justify-between shadow-lg
          transition-transform duration-500 ease-in-out transform origin-top ${showHeader
      ...
      {/* Ticket list */}
      <main
        className={`flex-1 overflow-y-auto px-4 pb-4 transition-[padding] duration-500 ${showHeader ? (deptsAllowedTabs.includes(activeTab) ? "pt-[200px]" : "pt-[150px]") : "pt-[150px]"
          }`}
      >
        ...
        {loading ? (
          ...
          <div>
            ...
            {filteredTickets.map((t, i) => (
              <div key={i} className="flex items-center justify-between bg-white dark:bg-gray-800 p-3 mb-5 rounded-xl shadow hover:shadow-lg hover:scale-[1.01] transition-[transform,box-shadow] duration-300" onClick={() => selectT(t)}>
