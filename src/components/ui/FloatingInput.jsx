    ...
    return (
      <div className="relative w-full overflow-visible pt-3">
        <input
          ...
          className={`peer w-full rounded-xl border px-3 pb-2.5 pt-4 text-base sm:text-sm text-gray-900 bg-white dark:text-gray-100 dark:bg-gray-800 outline-none transition-colors ${cls || ""}
