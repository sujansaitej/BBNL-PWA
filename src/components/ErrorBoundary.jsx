...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.recovering) {
      return (
        <div className="flex flex-col items-center justify-center min-h-dvh bg-gray-50 dark:bg-gray-900 px-6 text-center pt-safe pb-safe">
    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-dvh bg-gray-50 dark:bg-gray-900 px-6 text-center pt-safe pb-safe">
          ...
          <h1 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">Something went wrong</h1>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg shadow border hover:bg-gray-50 dark:hover:bg-gray-800 transition"
            >
              Go to Login
            </button>
          </div>
